...
export const appServerLogin = (loginInfo) => {
	return new Promise((resolve, reject) => {
		uni.request({
			url: "http://121.37.25.71:42233/auth/login",
			method: "POST",
...
export const appServerSendMsg = (phoneNumber) => {
	return new Promise((resolve, reject) => {
		uni.request({
			url: "http://121.37.25.71:42233/auth/code",
			method: 'POST',
...
export const appServerVerifyCode = (phoneNumber,verificationCode) => {
	return new Promise((resolve, reject) => {
		uni.request({
			url: "http://121.37.25.71:42233/auth/verify",
			method: 'POST',
...
export const appServerSetPwd = (phoneNumber,password,verificationCode) => {
	return new Promise((resolve, reject) => {
		uni.request({
			url: "http://121.37.25.71:42233/auth/password",
			method: 'POST',
...
export const importFriend = (uid, token) => {
	return new Promise((resolve, reject) => {
		uni.request({
			url: "http://121.37.25.71:10000/friend/import_friend",
			method: "POST",
			header: {
				"token":token
			},
...
export const importGroup = (uid, token) => {
	return new Promise((resolve, reject) => {
		uni.request({
			url: "http://121.37.25.71:10000/group/invite_user_to_group",
			method: "POST",
			header: {
				token
			},
